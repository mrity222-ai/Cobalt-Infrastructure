...
export function WhatsAppButton() {
  ...
  return (
    <Button
      asChild
      size="icon"
      className="fixed bottom-6 right-6 h-14 w-14 rounded-full bg-[#25D366] text-white hover:bg-[#128C7E] shadow-lg z-50 transition-transform hover:scale-110"
    >
      <Link href="https://wa.me/915224005093" target="_blank" rel="noopener noreferrer" aria-label="Chat on WhatsApp">
        <WhatsAppIcon />
      </Link>
    </Button>
  );
